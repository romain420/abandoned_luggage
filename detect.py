...
# ----------------------------------------------------------
    ...
    alertLauncher = LanceurAlerte(False) # Lanceur d'alerte est défini ici, False peu d'output, True pour le max d'informations
...
# -----------------------------------------------------------
                ...
                t4 = time_sync()
                outputs = deepsort.update(xywhs.cpu(), confs.cpu(), clss.cpu(), im0) # outputs = x1, x2, y1, y2, track_id, class_id
                coloration = alertLauncher.analyse_outputs(outputs, im0)
                ...
                if len(outputs) > 0:
                    for j, (output, conf) in enumerate(zip(outputs, confs)):
                        ...
                        annotator.box_label(bboxes, label, color=coloration[j])
